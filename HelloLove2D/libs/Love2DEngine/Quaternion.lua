...
local rawget = rawget
local rawset = rawset
local Vector3 = require('libs.Love2DEngine.Vector3')
...
---@class Love2DEngine.Quaternion:ClassType
local Quaternion = {}
local get = Class.init_get(Quaternion)
...
Love2DEngine.Quaternion = Quaternion
